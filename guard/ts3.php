<?php
$ip = @gethostbyname('192.168.2.205');
 ...
 */
   ...
   $i=2;
 //  while($i--){
      $out = str_split(socket_read($socket, 1024));
  //    sleep(1);
  // }
   /*
