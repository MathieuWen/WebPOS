...
(function(_global){
  ...
  _global.mchainClass.prototype = {
    ...
    openDatabase : function () {
      this.init();
      this.db = ZPOSDB.Zdb || window.openDatabase('zpos', '1.0', "ZDNPOS", 1024*1024);//window.openDatabase('zpos', '1.0', "ZDNPOS", 1024*1024); //window.openDatabase(dbname,"1.0","db",1024*1024) || 
      return this;
    },
    /** begin transaction
